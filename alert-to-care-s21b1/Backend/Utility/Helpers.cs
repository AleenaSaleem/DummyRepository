...
namespace Backend.Utility
{
    public class Helpers
    {
        ...
        private readonly string _icuDataCsvPath = new Repository.IcuRepository()._csvFilePath;
        private readonly string _patientDataCsvPath = new Repository.PatientRepository()._csvFilePath;
        private readonly string _bedDataCsvPath = new Repository.BedRepository()._csvFilePath;
